...
const linkClasses = ({ isActive }: { isActive: boolean }) =>
  `rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
    isActive ? 'bg-maroon-700 text-cream-50' : 'text-charcoal-700 hover:bg-cream-200'
  }`
...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-cream-200 bg-cream-50/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link to="/" className="flex items-center gap-2 text-lg font-bold text-maroon-800">
        ...
        <button
          type="button"
          className="min-h-11 min-w-11 rounded-lg p-2 text-charcoal-700 md:hidden"
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="min-h-11 rounded-lg px-3 py-2 text-sm font-medium text-charcoal-700 hover:bg-cream-200"
              >
                {strings.nav.logout}
              </button>
            </>
            ...
            <>
              ...
              <NavLink
                to="/signup"
                className="min-h-11 rounded-lg bg-maroon-700 px-3 py-2 text-sm font-medium text-cream-50 hover:bg-maroon-800"
              >
                {strings.nav.signup}
              </NavLink>
            </>
          ...
          {user ? (
            <>
              ...
              <button
                type="button"
                onClick={handleSignOut}
                className="min-h-11 rounded-lg px-3 py-2 text-left text-sm font-medium text-charcoal-700 hover:bg-cream-200"
              >
                {strings.nav.logout}
              </button>
            </>
